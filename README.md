...
## Modified for the spherical-radar-drone

Clone to `../ros2_ws/src/` along with `px4_ros_com`, then go to `../ros2_ws/src/px4_ros_com/scripts/` and run `./build_ros2_workspace.bash --verbose` to build.
